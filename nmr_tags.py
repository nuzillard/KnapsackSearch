...
familyname_knapsack.sdf: read by user, possibly using EdiSdf
...
nmr_tags.py appends NMR data to familyname_2D_tagged.sdf according to a trivial format
and writes the result to file familyname_knapsack.sdf
"""
...
sdfnameout = family + "_knapsack.sdf"
...
# append NMReDATA assignment tag to the current compound
		writer.write(m)
# write the current NMReDATA record to file familyname_knapsack.sdf
