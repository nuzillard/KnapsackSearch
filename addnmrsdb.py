...
# read a line for the current molecule that describes the change
			molOut = transform(molIn, nmr_line)
# get the changed molecule
...
# The name of a .txt file in C:\Users\jmn\AppData\Local\Temp that contains the raw result of the 13C
# chemical shift prediction
	command = "predictSdf " + filenameIn + " 4 3d 1>" + tempname1 + " 2>errorlog.txt"
